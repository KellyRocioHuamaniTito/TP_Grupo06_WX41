...
void configurarTabla()
{
	...
	void empezarJuego()
	{
		...
		for (int i = 0; i < 2; i++)
		{
			...
			{
				cadena = "";
				if (juego->getListaJugadores()[0]->getListaEstrategias()[i]->getListaNumeros()[j]->getEstado() != false && juego->getListaJugadores()[1]->getListaEstrategias()[i]->getFilaDominada()== false) { cadena += "("; }
				cadena += juego->getListaJugadores()[0]->getListaEstrategias()[i]->getListaNumeros()[j]->getNumero();
				if (juego->getListaJugadores()[0]->getListaEstrategias()[i]->getListaNumeros()[j]->getEstado() != false && juego->getListaJugadores()[1]->getListaEstrategias()[i]->getFilaDominada()==false) { cadena += ")"; }

				cadena += ",";

				if (juego->getListaJugadores()[1]->getListaEstrategias()[j]->getListaNumeros()[i]->getEstado() != false && juego->getListaJugadores()[1]->getListaEstrategias()[j]->getFilaDominada()== false) { cadena += "("; }
